...
#JAW
#JAWX
pos_Jaw1X = _gdml.Position("pos_Jaw1X", -110, 0., 360., "mm", reg)
...
pos_Jaw2X = _gdml.Position("pos_Jaw2X", 110., 0., 360., "mm", reg)
...
##JAWY
pos_Jaw1Y = _gdml.Position("pos_Jaw1Y", 0., -110., 270., "mm", reg)
...
pos_Jaw3Y = _gdml.Position("pos_Jaw3Y", 0., 0., 90., "cm", reg)
solidJaw4Y = _g4.solid.Box("solidJaw4Y", 10., 10., 10., reg, "cm")
solidJaw3Y = _g4.solid.Box("solidJaw3Y", 40., 40., 10., reg, "cm")
solidJaw = _g4.solid.Subtraction("solidJaw", solidJaw3Y, solidJaw4Y, [[0.,0.,0.],[0.,0.,0.]], reg)
...
##water phantom     
solidPhantom = _g4.solid.Box("solidPhantom", 40., 40., 40., reg, "cm")
logicPhantom = _g4.LogicalVolume(solidPhantom, air, "logicPhantom", reg)
physPhantom = _g4.PhysicalVolume([0.,0.,0.], [0.,0.,1200.], logicPhantom, "physPhantom", logicWorld, reg)
...
# write.write("phantom_water_new.gdml")